...
class TestCase {
  constructor({classname, name, time}) {
    Object.assign(this, {classname: classname, name: name, time: time, });
  }
  ...
  static from_non_compact_js(js) {
    const result = new TestCase(js.attributes);
...
module.exports = { TestSuites: TestSuites, TestSuite: TestSuite, TestCase: TestCase, };
